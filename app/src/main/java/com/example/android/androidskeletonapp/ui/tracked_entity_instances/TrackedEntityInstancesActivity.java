...
public class TrackedEntityInstancesActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUp(R.layout.activity_tracked_entity_instances, R.id.trackedEntityInstancesToolbar, R.id.trackedEntityInstancesRecyclerView);
...
//            String teiUid = Sdk.d2().programModule().programs.uid(selectedProgram).get().trackedEntityType().uid();
            ...
            OrganisationUnit organisationUnit = Sdk.d2().organisationUnitModule().organisationUnits
                    .byOrganisationUnitScope(OrganisationUnit.Scope.SCOPE_DATA_CAPTURE).one().get();
    ...
    private void observeTrackedEntityInstances() {
        ...
        getTeiRepository().getPaged(20).observe(this, trackedEntityInstancePagedList -> {
            ...
            findViewById(R.id.trackedEntityInstancesNotificator).setVisibility(trackedEntityInstancePagedList.isEmpty() ? View.VISIBLE : View.GONE);
        });
    }
